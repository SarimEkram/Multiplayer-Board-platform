...
public class TicTacToeLeaderboardTest {
    ...
    @BeforeEach
    void setUp() {
        leaderboard = TicTacToeLeaderboard.getInstance();
    ...
    void testNewPlayerIsSortedInLeaderboard() {
        ...
        TicTacToeLeaderboard.updatePlayer(newPlayer, true, gameType);
    ...
    void testLeaderboardIsSingletonInstance() {
        TicTacToeLeaderboard anotherInstance = TicTacToeLeaderboard.getInstance();
