...
public class CheckersLeaderboardTest {

    private CheckersLeaderboard leaderboard;
    ...
    @BeforeEach
    void setUp() {
        leaderboard = CheckersLeaderboard.getInstance();
    ...
    void testNewPlayerIsSortedInLeaderboard() {
        ...
        CheckersLeaderboard.updatePlayer(newPlayer, true, gameType);
    ...
    void testLeaderboardIsSingletonInstance() {
        CheckersLeaderboard anotherInstance = CheckersLeaderboard.getInstance();
